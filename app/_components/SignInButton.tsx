...
export default function SignInButton() {
  return (
    <div className="flex flex-col items-center text-center py-6 gap-6">
      ...
      <div>
        <h3 className="text-white text-xl font-bold mb-2">Sign in to Register</h3>
        <p className="text-white/50 text-sm leading-relaxed">
          Use your Google account to sign in and secure your spot at Finnomena Tech
          Outing 2026.
        </p>
      </div>
      <button
      ...
      <p className="text-white/30 text-xs">
        By registering, your name and team will be shared with the event organizers.
      </p>
    </div>
  )
}
